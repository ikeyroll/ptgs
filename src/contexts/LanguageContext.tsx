...
const translations: Translations = {
  ...
  'process.step2.desc': { ms: 'Muat naik dokumen sokongan yang diperlukan', en: 'Upload required supporting documents' },
  ...
  'process.step4.title': { ms: 'Terima Peralatan', en: 'Receive Equipment' },
  'process.step4.desc': { ms: 'Terima peralatan di Pejabat PTGS', en: 'Receive equipment at PTGS office' },
  ...
  // Application Form
  'form.title': { ms: 'Borang Permohonan Peralatan ICT', en: 'ICT Equipment Request Form' },
  ...
  'form.department': { ms: 'Jabatan', en: 'Department' },
  'form.phone': { ms: 'No. Telefon', en: 'Phone Number' },
  'form.email': { ms: 'E-mel', en: 'Email' },
  'form.address': { ms: 'Alamat', en: 'Address' },
  'form.equipmentInfo': { ms: 'Maklumat Peralatan', en: 'Equipment Information' },
  'form.equipmentType': { ms: 'Jenis Peralatan', en: 'Equipment Type' },
  'form.equipmentPurpose': { ms: 'Tujuan Permohonan', en: 'Request Purpose' },
  'form.documents': { ms: 'Dokumen Sokongan', en: 'Supporting Documents' },
  'form.icCopy': { ms: 'Salinan Kad Pengenalan', en: 'IC Copy' },
  'form.justification': { ms: 'Justifikasi Permohonan', en: 'Request Justification' },
  'form.approval': { ms: 'Kelulusan Ketua Jabatan', en: 'Department Head Approval' },
  ...
  'admin.subtitle': { ms: 'Pengurusan Peralatan ICT & Pendaftaran', en: 'ICT Equipment & Registration Management' },
  ...
  'admin.searchPlaceholder': { ms: 'Cari (No Rujukan, Email, Nama)', en: 'Search (Ref No, Email, Name)' },
  ...
  'admin.searchLabel': { ms: 'Cari (No Rujukan, No Siri, Nama)', en: 'Search (Ref No, Serial No, IC, Name)' },
